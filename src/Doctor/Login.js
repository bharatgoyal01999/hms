...
export default class LogIn extends React.Component{
   constructor(props){
    ...
    <View style={{flex:1 ,width:'100%'}}>
        ...
        <View style={{flex:0.15, backgroundColor:'#065D96',alignItems:'center'}}>
            <Text h3 style={{color:'white'}} > Hello Doctor</Text>
            <Text h4 style={{color:'white'}}>Please Login</Text>
        </View>
        <View style={{flex:0.5}} />
        <View style={{flex:0.35, backgroundColor:'#065D96',borderTopLeftRadius:150, borderTopRightRadius:150 }} />
       
        <Modal transparent visible={this.state.loginModal}>
        <View style={{width:300, alignSelf:'center', marginTop:270, elevation:5, borderRadius:20, paddingTop:20, height:300,backgroundColor:'#065D96'}}>
